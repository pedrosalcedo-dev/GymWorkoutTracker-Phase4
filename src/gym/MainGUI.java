...
// Pedro Salcedo
// CEN 3024 - Phase 4
// MainGUI: Swing GUI for the Gym Workout Tracker (now using SQLite).
...
public class MainGUI extends JFrame {
    ...
    // buttons (we toggle these on/off)
    ...
    public MainGUI() {
        ...
        // right side: table + custom button
        ...
        // start with DB actions disabled
    ...
    private void onDelete() {
        ...
        int ok = JOptionPane.showConfirmDialog(this,
                "Delete record " + id + "?", "Confirm", JOptionPane.YES_NO_OPTION);
    ...
    // UPDATE (select row -> edit left side -> click Update)
    ...
    // CUSTOM: uses selected row to show volume + best 1RM
    ...
    // fill the form when a row is clicked
